...
* **Publicador oficial (verified publisher)**
  ...
  ![](publicador-oficial.png)

* **Exemplo**

  ![](imagens-oficiais.png)
...
* **Exemplo**
  ...
  ![](aproveitamento-das-camandas-de-imagem.png)
...
* **Contextualização: Tipos de linguagem de programação**
  ...
  * **Interpretadas**
    ...
    ![](reprentacao-linguagem-interpretada.png)
  ...
  * **Compiladas**
    ...
    ![](reprentacao-linguagem-compilada.png)
